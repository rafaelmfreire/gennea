	...
	<footer class="bg-green-light20 py-4">
		<div class="flex flex-col sm:flex-row items-center justify-between econtainer padding-full">
			...
			<div class="flex items-center space-x-16 text-sm mt-4 sm:mt-0">
				Feito por:
				<a href="https://behance.net/rafaeldemacedo" target="_blank">
				...
				<!-- <ul class="flex items-center space-x-8 text-sm uppercase">
					<li><NuxtLink to="/como-funciona">Como Funciona</NuxtLink></li>
					<li><NuxtLink to="/contato">Contato</NuxtLink></li>
					<li><NuxtLink to="/pre-analise">Pré-Análise</NuxtLink></li>
				</ul>
				<div class="flex items-center space-x-4">
					<a href="https://www.instagram.com/gennea.assessoria/">
					<svg
						aria-hidden="true"
						focusable="false"
						data-icon="instagram"
						class="h-5 w-5 text-green-dark opacity-50"
						role="img"
